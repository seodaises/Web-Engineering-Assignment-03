...
const EditItem = () => {
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2">Edit Profile</h1>
        <p className="text-gray-600 dark:text-gray-400">Update your roommate profile details.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 md:p-8 shadow-sm max-w-3xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
          ...
          <div>
            ...
            <input
              type="text" id="preferredArea" name="preferredArea"
              value={formData.preferredArea} onChange={handleChange}
              className={inputClass} required
            />
          </div>
        </div>
        ...
        <div className="mb-5">
          ...
          <select
            ...
            value={formData.lifestyle} onChange={handleChange}
            className={inputClass}
          >
